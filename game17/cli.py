...
from game17.game17 import print_board, update_board, apply_diff
...
def replay(game, display_counts):
    ...
    game = json.load(game)
    game17.game_runners.replay(game)
...
def vs_zombies(players, output_directory, verbose, display_counts,
                board_size, num_rounds, kind_to_time_hogs, num_games):
    '''
    Play Game 17, battle royale, followed by round-robin run-off competitions.
